namespace ArduinoDriver.Samples.SMBTune {
    ...
    /// <summary>
    ///     This program uses the ArduinoLibCSharp libraries to play the Super Mario Bros *Underworld* tune on a connected
    ///     Arduino.
    ///     Since the constructor for the ArduinoDriver is passed 'true' for autobootstrap, this will automatically deploy the
    ///     listener
